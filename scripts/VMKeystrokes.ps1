...
<#
    ...
    .EXAMPLE
        Set-VMKeystrokes -VMName $VM -StringInput "root" -ReturnCarriage 1
    .EXAMPLE
        Set-VMKeystrokes -VMName $VM -StringInput "root" -DebugOn 1
#>
    param(
        ...
        [Parameter(Mandatory=$false)][int]$ReturnCarriage,
        [Parameter(Mandatory=$false)][int]$DebugOn
    )
	Install-Module -Name VMware.PowerCLI -Scope CurrentUser -Force
	Import-Module VMware.PowerCLI
	Connect-VIServer -Server $vCenterURL -force -User $vCenterUser -Password $vCenterPassword
